...
<head>
	...
	<!-- Google Fonts -->
	<link href="https://fonts.googleapis.com/css?family=Arizonia|Lobster|Marck+Script|Megrim|Sacramento|Stalemate|Tangerine:400,700&display=swap" rel="stylesheet">
...
<!-- <body> -->
	<nav id="navBar">
		...
		<menu id="mainMenu">
			<!-- TODO: account -->
			<figure id="mainMenuProfile" onclick="">
...
<!--
 ...
 -->
	...
	<section id="login">
		...
		<!-- var log = d.getElementById('signInputNick').value, pas = d.getElementById('signInputPass').value, -->
	</section>
