	...
	-->
		...
		<form id="addNew" action="" onkeypress="return event.keyCode != 13;">
			...
			<div id="addNewColr">
				...
				<label for="blc" class="colrOption"><input type="radio" name="colr" id="blc" class="colrOpt" onclick="box.selectColor(this.value)" value="5"><span id="blcCirc" class="checkmark"></span><p class="colrOptP">Void  </p></label>
		...
		<view class="newGroup">
			...
			<input type="text" name="" value="" placeholder="Name of group">
			<h4>add friends</h4>
			<ul class="newGroupFriendList">
				<li><input type="checkbox" id="a" name="a" value=""><label for="a">Tomas</label></li>
				<li><input type="checkbox" id="b" name="a" value=""><label for="b">Pepe</label></li>
				<li><input type="checkbox" id="c" name="a" value=""><label for="c">Carlos</label></li>
				<li><input type="checkbox" id="d" name="a" value=""><label for="d">Carlos</label></li>
				<li><input type="checkbox" id="e" name="a" value=""><label for="e">Carlos</label></li>
				<li><input type="checkbox" id="f" name="a" value=""><label for="f">Carlos</label></li>
				<li><input type="checkbox" id="g" name="a" value=""><label for="g">Carlos</label></li>
				<li><input type="checkbox" id="h" name="a" value=""><label for="h">Carlos</label></li>
				<li><input type="checkbox" id="i" name="a" value=""><label for="i">Carlos</label></li>
				<li><input type="checkbox" id="j" name="a" value=""><label for="j">Carlos</label></li>
				<li><input type="checkbox" id="k" name="a" value=""><label for="k">Carlos</label></li>
				<li><input type="checkbox" id="l" name="a" value=""><label for="l">Carlos</label></li>
				<li><input type="checkbox" id="m" name="a" value=""><label for="m">Carlos</label></li>
				<li><input type="checkbox" id="n" name="a" value=""><label for="n">Carlos</label></li>
				<li><input type="checkbox" id="o" name="a" value=""><label for="o">Carlos</label></li>
				<li><input type="checkbox" id="p" name="a" value=""><label for="p">Carlos</label></li>
				<li><input type="checkbox" id="q" name="a" value=""><label for="q">Carlos</label></li>
			</ul>
			<h4>or add new</h4>
